...
2. **Clean Syntax**: No angle brackets, fewer characters, clearer structure
3. **Data-Driven**: Templates naturally map to JSON/YAML data sources
4. **Component Reusability**: Partials make it easy to build component libraries
5. **Universal Tooling**: Use any YAML parser, linter, or validator
...
- **[RouteVN Website](https://github.com/RouteVN/routevn-website)** - Transportation website with multi-page structure and dynamic navigation
- **[Rettangoli.dev](https://github.com/yuusoft-org/rettangoli)** - Technical documentation site with code examples
- **[Yuusoft Projects](https://github.com/yuusoft-org)** - Various landing pages, docs sites, and component libraries
...
- **Rettangoli Sites**: https://github.com/yuusoft-org/rettangoli/tree/main/packages/rettangoli-sites
- **Rettangoli.dev Source**: https://github.com/yuusoft-org/rettangoli/tree/main/apps/rettangoli.dev
